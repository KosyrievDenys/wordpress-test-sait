	...
	class Test_Recent_Posts extends WP_Widget {
		...
		public function __construct() {
			$widget_ops = array(
				...
				'description'                 => __( 'Наші останні записи' ),
				'customize_selective_refresh' => true,
				'show_instance_in_rest'       => true,
			);
			parent::__construct( 'test-recent-posts', __( 'Свіжі записи TEST' ), $widget_ops );
		...
		public function widget( $args, $instance ) {
          ...
          <ul>
			  <?php foreach ( $r->posts as $recent_post ) : ?>
                ...
                <li>
                  <a
                    href="<?php the_permalink( $recent_post->ID ); ?>"<?php echo $aria_current; ?>><?php echo $title; ?></a>
					<?php if ( $show_date ) : ?>
