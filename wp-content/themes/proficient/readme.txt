...
Proficient WordPress Theme, Copyright 2023 Specia Theme
...
Proficient WordPress Theme is child theme of Specia WordPress Theme, Copyright 2021 Specia Theme
...
@version 3.0.55
* Widget Block Widget Calendar Caption Color Issue

@version 3.0.54
* Content Link Issue Fixed

@version 3.0.53
* Fixed Search Widget Button Color Issue in Blog
...
@version 3.0.43
* Blog Read More Button Focus Style Set
