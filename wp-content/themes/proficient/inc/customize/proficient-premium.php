...
function proficient_premium_setting( $wp_customize ) {
	...
	class Proficient_Buttons_Customize_Control extends WP_Customize_Control {
	public $type = 'upgrade_premium';
	   ...
	   function render_content() {
		?>
			...
			<div>
				<ul>
					...
					<li><a href="https://wordpress.org/support/theme/proficient/reviews/#new-post" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/rating.png"></a></li>
				</ul>
			</div>
		<?php
	   }
		...
		$wp_customize->add_control( new Proficient_Buttons_Customize_Control( $wp_customize, 'premium_info_buttons', array(
